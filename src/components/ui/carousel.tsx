...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return <div role="group" aria-roledescription="slide" data-slot="carousel-item" className={cn("min-w-0 shrink-0 grow-0 basis-full rounded-[8px]", orientation === "horizontal" ? "pl-4" : "pt-4", className)} {...props} />;
}
